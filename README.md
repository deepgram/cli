...
| Path | What happens |
| --- | --- |
| `~/.claude/commands/deepgram/` | Deletes `api.md`, `docs.md`, `setup-mcp.md`, `starters.md` and `deepgram.md` by name; a command you added stays, and the directory goes only if that empties it |
