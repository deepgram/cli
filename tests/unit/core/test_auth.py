...
from deepgram_cli.core.auth import AuthManager, AuthenticationError
...
def auth_manager(mock_config):
    ...
    with patch("deepgram_cli.core.auth.httpx.Client"):
...
class TestAuthManager:
    ...
    def test_login_with_api_key_success(self, auth_manager, mock_config):
        ...
        with patch.object(auth_manager, 'verify_credentials', return_value=(True, "Success", None)):
            # Mock keyring
            with patch('deepgram_cli.core.auth.keyring') as mock_keyring:
